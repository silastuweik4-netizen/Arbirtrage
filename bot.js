// ArbitrageBot.js - SIMPLIFIED VERSION: Aerodrome + Uniswap ONLY (no execution, full logging)
...
class ArbitrageBot {
  constructor() {
    ...
    console.log(chalk.blue(`📡 Initializing Detector for Base Chain (ID ${chainId})...`));
  ...
  async calculateNetProfit(tokenIn, tokenOut, amountIn, fee, pair) {
    ...
    // Reverse quote (best from either DEX)
    let amountOutB = 0n;
