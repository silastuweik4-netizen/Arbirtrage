//  zero-capital-main.js  — FIXED syntax error
import { config } from 'dotenv';
import { ZeroCapitalFlashEngine } from './zero-capital-main.js';  // FIXED: correct import
...
try {
  ...
  const wallet = Keypair.fromSeed(derivedSeed.key);
