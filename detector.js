...
class TokenPairManager {
  ...
  loadBasePairs() {
    // Popular Base Chain tokens with verified liquidity
    this.pairs = [
      {
        token0: '0x4200000000000000000000000000000000000006', // WETH
        token1: '0x833589fCD6eDb6E08f4c7C32D4f71b3566dA8aEF', // USDC
        name0: 'WETH',
        name1: 'USDC',
        dex0: 'uniswap_v3',
        dex1: 'aerodrome',
      ...
      {
        token0: '0x50c5725949A6F0c72E6C4a641F8e4dA7ff1f32ef', // USDbC
        token1: '0x833589fCD6eDb6E08f4c7C32D4f71b3566dA8aEF', // USDC
        name0: 'USDbC',
        name1: 'USDC',
        dex0: 'uniswap_v2',
      ...
      {
        token0: '0xd9aAEc86B65D86f6A259c19Cc27C5323d8F92A7e', // DEGEN
        token1: '0x833589fCD6eDb6E08f4c7C32D4f71b3566dA8aEF', // USDC
        name0: 'DEGEN',
        name1: 'USDC',
        dex0: 'uniswap_v3',
  ...
  async validateTokens(token0, token1) {
    try {
      ...
      const [decimals0, decimals1, symbol0, symbol1] = await Promise.all([
        erc20_0.decimals().catch(() => null),
        erc20_1.decimals().catch(() => null),
