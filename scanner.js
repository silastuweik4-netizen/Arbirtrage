...
class ArbitrageScanner {
    ...
    logOpportunity(pair, aeroPrice, pancakePrice, decOut) {
        ...
        // Log spreads >= 0.05% (after fees, need 0.4%+ to be profitable)
        if (spread >= 0.05) {
            ...
            console.log(`  📈 ${pair.padEnd(20)} | Aero: ${aeroPrice.padEnd(15)} | Pancake: ${pancakePrice.padEnd(15)} | Spread: ${spread.toFixed(4)}% | Buy: ${cheaperDex}`);
    ...
    async scanForArbitrageOpportunities() {
        ...
        // 🎯 OPTIMIZED - Testing different amounts to find best spreads
        const pairsToScan = [
            // ✅ WORKING PAIRS - Confirmed on both Aerodrome & PancakeSwap
            
            // 🚀 VIRTUAL - AI token (has liquidity)
            { name: "VIRTUAL/WETH", in: TOKENS.VIRTUAL, out: TOKENS.WETH, inDec: 18, outDec: 18, amountInScaled: ethers.parseUnits("10", 18) },
            { name: "VIRTUAL/WETH (50)", in: TOKENS.VIRTUAL, out: TOKENS.WETH, inDec: 18, outDec: 18, amountInScaled: ethers.parseUnits("50", 18) },
            { name: "WETH/VIRTUAL", in: TOKENS.WETH, out: TOKENS.VIRTUAL, inDec: 18, outDec: 18, amountInScaled: ethers.parseUnits("1", 18) },
            { name: "WETH/VIRTUAL (5)", in: TOKENS.WETH, out: TOKENS.VIRTUAL, inDec: 18, outDec: 18, amountInScaled: ethers.parseUnits("5", 18) },
            
            // 🔥 cbBTC - Bitcoin derivative (HIGH VALUE - test large amounts!)
            { name: "cbBTC/WETH", in: TOKENS.cbBTC, out: TOKENS.WETH, inDec: 8, outDec: 18, amountInScaled: ethers.parseUnits("0.1", 8) },
            { name: "cbBTC/WETH (0.5)", in: TOKENS.cbBTC, out: TOKENS.WETH, inDec: 8, outDec: 18, amountInScaled: ethers.parseUnits("0.5", 8) },
            { name: "cbBTC/WETH (1)", in: TOKENS.cbBTC, out: TOKENS.WETH, inDec: 8, outDec: 18, amountInScaled: ethers.parseUnits("1", 8) },
            
            { name: "WETH/cbBTC", in: TOKENS.WETH, out: TOKENS.cbBTC, inDec: 18, outDec: 8, amountInScaled: ethers.parseUnits("1.0", 18) },
            { name: "WETH/cbBTC (5)", in: TOKENS.WETH, out: TOKENS.cbBTC, inDec: 18, outDec: 8, amountInScaled: ethers.parseUnits("5.0", 18) },
            { name: "WETH/cbBTC (10)", in: TOKENS.WETH, out: TOKENS.cbBTC, inDec: 18, outDec: 8, amountInScaled: ethers.parseUnits("10.0", 18) },
            
            { name: "cbBTC/USDC (0.1)", in: TOKENS.cbBTC, out: TOKENS.USDC, inDec: 8, outDec: 6, amountInScaled: ethers.parseUnits("0.1", 8) },
            { name: "cbBTC/USDC (0.5)", in: TOKENS.cbBTC, out: TOKENS.USDC, inDec: 8, outDec: 6, amountInScaled: ethers.parseUnits("0.5", 8) },
            { name: "cbBTC/USDC (1)", in: TOKENS.cbBTC, out: TOKENS.USDC, inDec: 8, outDec: 6, amountInScaled: ethers.parseUnits("1", 8) },
            
            { name: "USDC/cbBTC (10k)", in: TOKENS.USDC, out: TOKENS.cbBTC, inDec: 6, outDec: 8, amountInScaled: ethers.parseUnits("10000", 6) },
            { name: "USDC/cbBTC (50k)", in: TOKENS.USDC, out: TOKENS.cbBTC, inDec: 6, outDec: 8, amountInScaled: ethers.parseUnits("50000", 6) },
            { name: "USDC/cbBTC (100k)", in: TOKENS.USDC, out: TOKENS.cbBTC, inDec: 6, outDec: 8, amountInScaled: ethers.parseUnits("100000", 6) },
            
            // 💰 WETH/USDC - Base pair (test all sizes)
            { name: "WETH/USDC (1)", in: TOKENS.WETH, out: TOKENS.USDC, inDec: 18, outDec: 6, amountInScaled: ethers.parseUnits("1.0", 18) },
            { name: "WETH/USDC (5)", in: TOKENS.WETH, out: TOKENS.USDC, inDec: 18, outDec: 6, amountInScaled: ethers.parseUnits("5.0", 18) },
            { name: "WETH/USDC (10)", in: TOKENS.WETH, out: TOKENS.USDC, inDec: 18, outDec: 6, amountInScaled: ethers.parseUnits("10.0", 18) },
            
            { name: "USDC/WETH (1k)", in: TOKENS.USDC, out: TOKENS.WETH, inDec: 6, outDec: 18, amountInScaled: ethers.parseUnits("1000", 6) },
            { name: "USDC/WETH (5k)", in: TOKENS.USDC, out: TOKENS.WETH, inDec: 6, outDec: 18, amountInScaled: ethers.parseUnits("5000", 6) },
            { name: "USDC/WETH (10k)", in: TOKENS.USDC, out: TOKENS.WETH, inDec: 6, outDec: 18, amountInScaled: ethers.parseUnits("10000", 6) },
        ];
