// config.js - COMPLETE & COMPATIBLE (Uniswap V3 + Aerodrome only)
module.exports = {
    ...
    settings: {
        executionThreshold: 0.05,           // Low enough to catch tiny positives (for detection only)
        maxFlashloanAmount: '1000',
        gasLimit: 800000,
        scanInterval: 6000,                 // 6 seconds – frequent checks
        depthAmount: 20,
