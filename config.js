// config.js - Updated to include PancakeSwap V3 contracts + kept realistic fees
module.exports = {
    ...
    // Contract Addresses - ADDED PancakeSwap V3
    contracts: {
        ...
        pancakeRouter: '0x678Aa4bF4E210cf2166753e054d5b7c31cc7fa86'.toLowerCase(),  // PancakeSwap Router on Base
        pancakeQuoter: '0xB048Bbc1Ee6b733FFfCFb9e9CeF7375518e25997'.toLowerCase(),  // PancakeSwap Quoter on Base
        pancakeFactory: '0x8c7E386D95577F1f1A71093D1de1A72044e3d8eB'.toLowerCase()  // PancakeSwap Factory on Base
    },

    // Trading Settings
    settings: {
        executionThreshold: 0.50,           // USD — kept low for testing
