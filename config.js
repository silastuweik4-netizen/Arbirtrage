// config.js - Updated with realistic Uniswap V3 fees + debug-friendly settings
module.exports = {
    ...
    // Contract Addresses
    contracts: {
        arbitrageContract: '0x0301304b0fd60f178d2814f72b575e67a7987e1e'.toLowerCase(), // update if redeployed
    ...
    // Trading Settings - lowered threshold & relaxed delays for debugging
    settings: {
        executionThreshold: 0.50,           // ← lowered from 5 to 0.50 so we see attempts
