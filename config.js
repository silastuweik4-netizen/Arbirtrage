...
module.exports = {
    ...
    contracts: {
        ...
        uniswapV3Quoter: '0x3d4e44Eb1374240CE5F1B871ab261CD16335B76a', // Fixed: Correct property name
        aerodromeRouter: '0xcF77a3Ba9A5CA399B7c97c74d54e5b1Beb874E43',
        aerodromeFactory: '0x420DD381b31aEf6683db6B902084cB0FFECe40Da' // Added: Needed for Aerodrome swaps
    },

    // Trading Settings
    settings: {
        executionThreshold: 5.00, // Minimum $5 profit to execute
        maxFlashloanAmount: 1000, // Max amount to borrow in USD (changed from string to number)
        gasLimit: 500000,
        scanInterval: 10000 // 10 seconds
    },

    // Token List (with decimals added)
    tokens: {
    ...
    // Pair List (55 Pairs - example subset)
    pairs: [
        ...
        { name: 'DAI/USDC', token0: 'DAI', token1: 'USDC', fee: 500 },
        { name: 'AERO/WETH', token0: 'AERO', token1: 'WETH', fee: 3000 },
        { name: 'DEGEN/WETH', token0: 'DEGEN', token1: 'WETH', fee: 10000 },
        // Add more pairs from your full list
    ]
};
