...
module.exports = {
  ...
  BASE_RPC_URL: 'https://mainnet.base.org', // Free, official Base RPC
  CHAIN_ID: 8453,

  // Wallet Configuration
  PRIVATE_KEY: process.env.PRIVATE_KEY || '',

  // Contract Addresses (auto-checksummed)
  contracts: {
    ...
    aerodromeFactory:   getAddress('0x5C3F18F06CC09CA1910767A7a647aD5e8C9e2c5F'), // now valid
  },

  // Trading Settings
  settings: {
    executionThreshold: 5.00,      // min $5 profit
    maxFlashloanAmount: '1000',    // USD
    gasLimit: 500000,
    scanInterval: 10000,           // 10s
    updateInterval: 10000,         // 10s
    depthAmount: 10                // test size cap
  },
