...
module.exports = {
  ...
  contracts: {
    ...
    arbitrageContract: '0x0000000000000000000000000000000000000000', // Replace with your deployed contract address
  },
  ...
  tokens: {
    ...
    MORPHO: { address: '0x9994cc8b24e1d738fdbeac602f9c2903e800ee0b', decimals: 18, symbol: 'MORPHO' },
  ...
  PRIVATE_RPC_URL: '', // Optional: Add your private RPC URL here
  PRIVATE_KEY: '', // Required: Add your wallet private key here
};
