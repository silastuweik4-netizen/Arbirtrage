// config.js - UPDATED with Alchemy MEV-Protected RPC
module.exports = {
    // Network Configuration - UPDATED with Alchemy
    BASE_RPC_URL: 'https://base-mainnet.g.alchemy.com/v2/c9sgWYXHHHwxgwSSDwR6gP8PWB5MuTQ0',
    
    // Use same RPC for execution (Alchemy provides MEV protection)
    ...
    settings: {
        ...
        gasLimit: 500000,
        scanInterval: 10000, // 10 seconds between scans
        depthAmount: 10, // Test up to 10 tokens for optimal size
        
        // Rate limiting settings (prevents RPC overload)
        maxConcurrentChecks: 3, // Check 3 pairs at once max
        delayBetweenChecks: 200, // 200ms delay between pair checks
    },
    ...
    // Pair List - VERIFIED TOKEN PAIRS ONLY
    pairs: [
        ...
        // Staked ETH pairs (lower fees = more liquid)
