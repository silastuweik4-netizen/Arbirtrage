// config.js - FINAL VERSION with One-Shot Mode and Slippage Protection
module.exports = {
    ...
    settings: {
        ...
        stopAfterFailure: true, // <--- STOP AFTER FIRST ATTEMPT (SUCCESS OR FAILURE) // Stop bot after first execution attempt (success OR failure)
        ...
        // --- NEW: Slippage Tolerance (in Basis Points, 50 = 0.5%) ---
