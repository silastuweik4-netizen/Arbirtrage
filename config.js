// config.js - FIXED VERSION with Correct Fees, Reduced Delays for Debugging
module.exports = {
    ...
    settings: {
        ...
        gasLimit: 500000,
        scanInterval: 8000, // Reduced to 8s for debugging
        ...
        delayBetweenChecks: 200, // Reduced to 200ms for debugging
