//  src/memescanner.js  – identical-mint, dual-oracle, Jupiter-verified, debug-ready
...
async function scanMint(mint) {
  ...
  // ===== HTTP call + live debug =====
  const res = await fetch(`https://api.dexscreener.com/latest/dex/tokens/${mint}`);
  console.log('[HTTP]', res.status, res.url);                       // ✅ added
  if (!res.ok) console.log('[HTTP BODY]', await res.text());        // ✅ added
  // ===================================
