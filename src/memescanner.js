//  src/memescanner.js  – safety-gated, bullet-proof fetch, crash-proof
...
async function scanMint(mint) {
  ...
  // bullet-proof fetch: 3 s timeout, soft fail on block
...
async function scanAll() {
  ...
  for (const r of valid) {
    ...
    const msg =
      `🚨 <b>Live Mint Arb ≥ ${Number(process.env.MEME_MIN_SPREAD || 0.2)}%</b>\n` +
